...
route.get('/user/surat/:idlayanan', [mid.checkRolesAndLogout(['Admin Instansi', 'Admin Verifikasi', 'Super Admin'])], suratController.getsurat); 

//untuk print pdf berserta permohonan user
route.get('/user/surat/:idlayanan/:idforminput', [mid.checkRolesAndLogout(['Admin Instansi', 'Admin Verifikasi', 'Super Admin', 'User'])], suratController.getsurat); 

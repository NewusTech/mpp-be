...
route.get('/user/artikel/get', [mid.checkRolesAndLogout(['Admin Instansi', 'Super Admin', 'User'])], artikelController.getartikel); 
route.get('/user/artikel/get/:id', [mid.checkRolesAndLogout(['Admin Instansi', 'Super Admin', 'User'])], artikelController.getartikelById); 

...
route.post('/user/inputform/create/:idlayanan', [mid.checkRolesAndLogout(['User', 'Admin Instansi', 'Super Admin'])], upload.any(), layananforminput.inputform);
...
route.put('/user/inputform/file/:idlayanannum', [mid.checkRolesAndLogout(['Admin Instansi', 'Super Admin'])], upload.single('file'), layananforminput.uploadfilehasil);

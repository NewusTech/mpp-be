...
route.get('/user/survey/form/:instansiid', [mid.checkRolesAndLogout(['Admin Instansi', 'Admin Verifikasi', 'Super Admin', 'User'])], surveyformController.getsurveybydinas); 
route.get('/user/survey/formbyid/:idsurvey', [mid.checkRolesAndLogout(['Admin Instansi', 'Admin Verifikasi', 'Super Admin', 'User'])], surveyformController.getsurveybyidsurvey); 

...
route.get('/user/bookingantrian/get/:slugdinas', [mid.checkRolesAndLogout(['Admin Instansi', 'Super Admin', 'Admin Verifikasi', 'Bupati'])], bookingantrianController.getbookingantrian); 
...
route.get('/user/bookingantrian/:idbookingantrian', [mid.checkRolesAndLogout(['User', 'Admin Instansi', 'Super Admin'])], bookingantrianController.getbookingantrianbyid); 
